...
export const metadata: Metadata = {
  title: "Offers",
  description: "Discover the best data bundle offers in Ghana. Save more with BundleArena.",
    ...
    <div className="min-h-screen bg-[#f6f8fb]">
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">BundleArena Offers</p>
