        ...
        <section className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          <div className="rounded-3xl bg-[var(--accent)] p-8 text-[#0f172a] shadow-[0_18px_40px_rgba(var(--accent-rgb)/0.35)]">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl bg-white/60 px-4 py-4 text-sm">
                <p className="text-xs font-semibold text-[#0f172a]/60">Total Purchases</p>
          ...
          {activities.length > PAGE_SIZE ? (
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 px-6 py-4">
              <p className="text-sm text-slate-600">
                Showing {(walletPage - 1) * PAGE_SIZE + 1}–{Math.min(walletPage * PAGE_SIZE, activities.length)} of {activities.length}
              </p>
